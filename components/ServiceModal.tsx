                            ...
                            {activeTab === 'info' && (
                                <div className="grid grid-cols-1 gap-4 md:gap-6">
                                    ...
                                    <div className="glass-panel p-4 md:p-6 rounded-2xl border border-blue-500/30 bg-gradient-to-r from-blue-900/20 to-slate-900">
                                        <label className="text-xs text-blue-400 font-bold block mb-2 md:mb-4 uppercase tracking-wider flex items-center gap-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                                            ...
                                            <div className="space-y-1.5 md:space-y-2">
                                                ...
                                                <input className="w-full bg-slate-900 border border-slate-700 rounded-xl p-3 text-sm text-slate-200" value={formData.clientPhone} onChange={(e) => handleInputChange('clientPhone', e.target.value)} type="tel" placeholder="(00) 00000-0000" />
                                            </div>
                                            <div className="space-y-1.5 md:space-y-2">
